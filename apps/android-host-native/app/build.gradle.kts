...
android {
    ...
    defaultConfig {
        // Different applicationId so this installs ALONGSIDE the attended host.
        applicationId = "com.nikhil.updeskhostnative"
        minSdk = 26          // Android 8.0 — MediaProjection + foreground services
        targetSdk = 36
        versionCode = 1
        versionName = "0.1.0"

        // arm64 only — drops the other-ABI copies of the WebRTC engine.
    ...
    // lintVital pulls an artifact at build time; not needed to produce the APK.
    lint {
